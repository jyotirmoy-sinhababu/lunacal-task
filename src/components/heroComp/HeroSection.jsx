...
const HeroSection = () => {
  return (
    <div className='bg-[#363C43] h-[29vh] w-[37%] mt-[5.5%] ml-[3%] z-30 rounded-[21px] flex'>
      ...
      <div className='flex flex-col items-center  bg-transparent'>
        <div className='flex  bg-[#171717] mt-[22px] rounded-[20px] h-[49px] z-20 '>
          <button className='w-[165px] text-[#A3ADB2] flex justify-center items-center focus:shadow-2xl focus:shadow-black focus:z-40 focus:bg-[#363C43] hover:bg-[#363C43] rounded-[20px] m-[3px]'>
            About
          </button>
          <button className='w-[165px] text-[#A3ADB2] flex justify-center items-center focus:shadow-2xl focus:shadow-black focus:z-40 focus:bg-[#363C43] hover:bg-[#363C43] rounded-[20px] m-[3px]'>
            Experiences
        ...
        <div className='flex justify-center items-center bg-transparent mx-[25px] mt-[19px]'>
          <p className='bg-transparent text-[#A3ADB2] text-[1.1rem]'>
